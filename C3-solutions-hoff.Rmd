...
theta.mc <- rnorm(10000, 4.1, sigma2.mc / 20)
```
...
y.mc <- 0.31 * rnorm(N, theta.mc, sigma.mc) + 0.46 * rnorm(N, 2 * theta.mc, 2 * sigma.mc) + 0.23 * rnorm(N, 3 * theta.mc, 3 * sigma.mc)
...
legend(4, 0.006, legend=c("greater than cutoff", "less or equal than cutoff"),col=c("red", "blue"), lty=1:1, cex=0.8)
```
